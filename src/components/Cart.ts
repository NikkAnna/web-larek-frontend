...
export class Cart extends Component<ICart> {
    ...
    constructor(container: HTMLElement, events: IEvents) {
        ...
        this.events = events;
        this._productsContainer = ensureElement<HTMLElement>('.basket__list', this.container);
        this._buttonCreateOrder = ensureElement<HTMLButtonElement>('.basket__button', this.container);
