...
export class Page extends Component<IPage> implements IPage {
    ...
    constructor(container: HTMLElement, events: IEvents) {
        ...
        this.productsInCart = ensureElement<HTMLElement>('.header__basket-counter', this.container);
        this.wrapper = ensureElement<HTMLElement>('.page__wrapper', this.container);
        this.cartButton = ensureElement<HTMLElement>('.header__basket', this.container);
        this.events = events;
